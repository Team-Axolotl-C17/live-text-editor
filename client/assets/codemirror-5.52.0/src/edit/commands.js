...
export let commands = {
  ...
  goLineStart: (cm) =>
    cm.extendSelectionsBy((range) => lineStart(cm, range.head.line), {
      origin: '+move',
      bias: 1,
    }),
  goLineStartSmart: (cm) =>
    cm.extendSelectionsBy((range) => lineStartSmart(cm, range.head), {
      origin: '+move',
      bias: 1,
    }),
  goLineEnd: (cm) =>
    cm.extendSelectionsBy((range) => lineEnd(cm, range.head.line), {
      origin: '+move',
      bias: -1,
    }),
  goLineRight: (cm) =>
