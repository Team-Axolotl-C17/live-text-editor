...
(function () {
  ...
  MT(
    'indent_semicolonless_if_with_statement',
    '[keyword function] [def foo]() {',
    '  [keyword if] ([variable x])',
    '    [variable foo]()',
    '  [variable bar]()',
  ...
  MT(
    'bigint',
    '[number 1n] [operator +] [number 0x1afn] [operator +] [number 0o064n] [operator +] [number 0b100n];'
  );
  ...
  TS(
    'typescript_interface_with_const',
  ...
  TS(
    'typescript_type_when_not_keyword',
  ...
  TS(
    'typescript_complex_return_type',
    '[keyword function] [def A]() {',
  ...
  TS(
    'typescript_complex_type_casting',
