...
(function () {
  ...
  MT(
    'simple_test',
    '[meta <?php] ' + '[keyword echo] [string "aaa"]; ' + '[meta ?>]'
  );

  MT(
    'variable_interpolation_non_alphanumeric',
    '[meta <?php]',
  ...
  MT(
    'variable_interpolation_simple_syntax_1',
    '[meta <?php]',
  ...
  MT(
    'variable_interpolation_simple_syntax_2',
    '[meta <?php]',
    '[keyword echo] [string "][variable-2 $aaaa][[',
    '[number 2]',
    ']][string aa"];',
    '[keyword echo] [string "][variable-2 $aaaa][[',
    '[number 2345]',
    ...
    '[keyword echo] [string "1aaa][variable-2 $aaaa][[',
    '[number 2]',
    ']][string aa"];',
    '[keyword echo] [string "aaa][variable-2 $aaaa][[',
    '[number 2345]',
    ']][string aa"];',
    '[keyword echo] [string "aaa][variable-2 $aaaa][[',
    '[number 2.3]',
  ...
  MT(
    'variable_interpolation_simple_syntax_3',
    '[meta <?php]',
  ...
  MT(
    'variable_interpolation_escaping',
  ...
  MT(
    'variable_interpolation_complex_syntax_1',
    '[meta <?php]',
    ...
    '[keyword echo] [string "aaa][variable-2 $]{[variable-2 $aaaa][[',
    '  [number 42]',
    ']]}[string ->aaa.aaa"];',
  ...
  MT(
    'variable_interpolation_complex_syntax_2',
    ...
    '  [string "aaa][variable-2 $aaa][string {}][variable-2 $]{[variable aaa]}[string "]',
    ']]}[string ->aaa.aaa"];',
  ...
  function build_recursive_monsters(nt, t, n) {
    var monsters = [t];
    for (var i = 1; i <= n; ++i) monsters[i] = nt.join(monsters[i - 1]);
    return monsters;
  }
  ...
  MT(
    'variable_interpolation_complex_syntax_3_1',
  ...
  var m2 = build_recursive_monsters(
    [
      '[string "a][variable-2 $]{[variable aaa] [operator +] ',
      ' [operator +] ',
      '}[string .a"]',
    ],
  ...
  MT(
    'variable_interpolation_complex_syntax_3_2',
  ...
  MT(
    'variable_interpolation_complex_syntax_3_3',
    '[meta <?php] [comment /* Recursive monsters 2 */]',
    '[keyword echo] ' + m3[4] + ';',
    '[keyword echo] ' + m3[0] + ';',
    '[keyword echo] ' + m3[3] + ';',
  ...
  MT(
    'variable_interpolation_heredoc',
    '[meta <?php]',
    '[string <<<here]',
