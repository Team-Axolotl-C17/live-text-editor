...
(function () {
  ...
  MT('namespace-test', '[keyword {namespace] [variable namespace][keyword }]');

  MT(
    'namespace-with-attribute-test',
  ...
  MT('param-type-any', '[keyword {@param] [def unknown]: [type ?][keyword }]');
  ...
  MT('undefined-var', '[keyword {][variable-2&error $var]');
  ...
  MT(
    'tag-starting-with-function-call-is-not-a-keyword',
  ...
  MT('highlight-command-at-eol', '[keyword {msg]', '    [keyword }]');
