...
(function () {
  ...
  MT(
    "xù/ msgenny constants classify as 'variable'",
    '[variable auto]',
    '[variable true]',
    '[variable false]',
    '[variable on]',
  ...
  MT(
    'mscgen options classify as keyword',
    '[keyword hscale]',
    '[keyword width]',
    '[keyword arcgradient]',
    '[keyword wordwraparcs]'
  );
  ...
  MT(
    'within an attribute list, mscgen/ xù attributes classify as base',
    '[base [[label]',
    '[base idurl id url]',
  ...
  MT(
    'outside an attribute list, mscgen/ xù attributes classify as base',
    '[base label]',
    '[base idurl id url]',
    '[base linecolor linecolour textcolor textcolour textbgcolor textbgcolour]',
    '[base arclinecolor arclinecolour arctextcolor arctextcolour arctextbgcolor arctextbgcolour]',
