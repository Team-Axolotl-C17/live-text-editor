...
(function () {
  ...
  MT(
    'no_indent_after_single_line_if',
    '[keyword if] [bracket (][variable foo][bracket )] [keyword break];',
    ''
  );

  MT(
    'indent_after_if_begin_same_line',
  ...
  MT(
    'indent_after_if_begin_next_line',
    '[keyword if] [bracket (][variable foo][bracket )]',
    '    [keyword begin]',
    '        [keyword break];',
    '        [keyword break];',
  ...
  MT(
    'indent_single_statement_if_else',
    '[keyword if] [bracket (][variable foo][bracket )]',
    '    [keyword break];',
    '[keyword else]',
    '    [keyword break];',
  ...
  MT(
    'unindent_after_end_with_preceding_text',
    '[keyword begin]',
  ...
  MT(
    'export_task_two_lines_indents_properly',
    '[keyword export]',
