...
(function () {
  ...
  test(
    'ignoreExternalBlockCommentsMultiLineAbove',
    'javascript',
    function (cm) {
    ...
    [
      ...
      multiLineInlineBlock[2],
    ].join('\n')
  );

  test(
    'ignoreExternalBlockCommentsMultiLineBelow',
    'javascript',
    function (cm) {
      cm.setSelection(
        { line: 1, ch: 13 /* after end of block comment */ },
        { line: 2, ch: 1 }
      );
      cm.execCommand('toggleComment');
    },
